...
import { TenantSpendPageComponent } from "./features/tenant-spend/tenant-spend-page.component";
...
export const appRoutes: Routes = [
  ...
  { path: "tenant-spend", component: TenantSpendPageComponent, canActivate: [authGuard] },
